...
Intro:
  The f4_freertos_template is meant to help users get started quickly on
  the F4 Discovery Board from ST Micro, using Open Source Tools. This template
  contains all the necessary code and configurations to support freertos 
  integration.
